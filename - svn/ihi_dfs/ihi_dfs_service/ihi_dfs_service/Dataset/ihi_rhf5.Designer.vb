...
Namespace ihi_rhf5TableAdapters
    ...
    Partial Public Class LINE_MASTERTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ihi_dfs_service.My.MySettings.Default.ihi_rhf5_ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ID, LINE_NAME, READ_ASCII_LENGTH, READ_BCD_LENGTH, ROOT_PATH, ROOT_TEMP, S"& _ 
                "EQ, SLEEP_INTERVAL, SYNC_TIME_WHEN, USE_CSV_MODE, USE_XLS_MODE FROM LINE_MASTER "& _ 
    ...
    Partial Public Class MACHINETableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT COPY_FILE, COPY_PATH, COPY_PERIOD_MILLISEC, COPY_PURGE_OLD_PATH, COPY_PURG"& _ 
                ...
                "FORMAT_MC, FORMAT_MODE, FORMAT_SERIAL_BH, FORMAT_SERIAL_CS, FORMAT_SERIAL_CW, FO"& _ 
                "RMAT_SERIAL_ITA, FORMAT_SERIAL_TS, FORMAT_STATUS, ID, LINE_ID, MACHINE_NAME, MAC"& _ 
                "HINE_NO, PATH, PLC_NET, PLC_NODE, PLC_UNIT, READ_DATA_ADDRESS, READ_STATUS_ADDRE"& _ 
                "SS, READ_STATUS_LENGTH, SEQ, WRITE_LIFE_ADDRESS, WRITE_STATUS_ADDRESS, WRITE_SYN"& _ 
                "C_ADDRESS FROM MACHINE WHERE (LINE_ID = @LINE_ID)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class SERIALTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [SERIAL] WHERE (([SERIAL_ID] = @Original_SERIAL_ID) AND ([SERIAL_BH] "& _ 
                ...
                "_ITA)) AND ([CREATED_WHEN] = @Original_CREATED_WHEN) AND ((@IsNull_SERIAL_TS = 1"& _ 
                " AND [SERIAL_TS] IS NULL) OR ([SERIAL_TS] = @Original_SERIAL_TS)) AND ((@IsNull_"& _ 
                "SERIAL_CW = 1 AND [SERIAL_CW] IS NULL) OR ([SERIAL_CW] = @Original_SERIAL_CW)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_SERIAL_ID", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "SERIAL_ID", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [SERIAL] ([SERIAL_BH], [SEQ_NO], [SERIAL_CS], [SERIAL_ITA], [CREATED_"& _ 
                "WHEN], [SERIAL_TS], [SERIAL_CW]) VALUES (@SERIAL_BH, @SEQ_NO, @SERIAL_CS, @SERIA"& _ 
                "L_ITA, @CREATED_WHEN, @SERIAL_TS, @SERIAL_CW);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SERIAL_ID, SERIAL_BH, SEQ"& _ 
                "_NO, SERIAL_CS, SERIAL_ITA, CREATED_WHEN, SERIAL_TS, SERIAL_CW FROM SERIAL WHERE"& _ 
                " (SERIAL_ID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [SERIAL] SET [SERIAL_BH] = @SERIAL_BH, [SEQ_NO] = @SEQ_NO, [SERIAL_CS] = @"& _ 
                "SERIAL_CS, [SERIAL_ITA] = @SERIAL_ITA, [CREATED_WHEN] = @CREATED_WHEN, [SERIAL_T"& _ 
                "S] = @SERIAL_TS, [SERIAL_CW] = @SERIAL_CW WHERE (([SERIAL_ID] = @Original_SERIAL"& _ 
                "_ID) AND ([SERIAL_BH] = @Original_SERIAL_BH) AND ([SEQ_NO] = @Original_SEQ_NO) A"& _ 
                "ND ((@IsNull_SERIAL_CS = 1 AND [SERIAL_CS] IS NULL) OR ([SERIAL_CS] = @Original_"& _ 
                "SERIAL_CS)) AND ((@IsNull_SERIAL_ITA = 1 AND [SERIAL_ITA] IS NULL) OR ([SERIAL_I"& _ 
                "TA] = @Original_SERIAL_ITA)) AND ([CREATED_WHEN] = @Original_CREATED_WHEN) AND ("& _ 
                "(@IsNull_SERIAL_TS = 1 AND [SERIAL_TS] IS NULL) OR ([SERIAL_TS] = @Original_SERI"& _ 
                "AL_TS)) AND ((@IsNull_SERIAL_CW = 1 AND [SERIAL_CW] IS NULL) OR ([SERIAL_CW] = @"& _ 
                "Original_SERIAL_CW)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SERIAL_ID, SERIAL_BH, SEQ_NO, SERIAL_CS, SERIAL_I"& _ 
                "TA, CREATED_WHEN, SERIAL_TS, SERIAL_CW FROM SERIAL WHERE (SERIAL_ID = @SERIAL_ID"& _ 
                ")"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT CREATED_WHEN, SEQ_NO, SERIAL_BH, SERIAL_CS, SERIAL_CW, SERIAL_ID, SERIAL_I"& _ 
                "TA, SERIAL_TS FROM SERIAL AS s WHERE (SERIAL_BH = @SERIAL_BH)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY SEQ_NO D"& _ 
                "ESC"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy_FindSerial_BH(ByVal dataTable As ihi_rhf5.SERIALDataTable, ByVal SERIAL_BH As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy_FindSerial_BH(ByVal SERIAL_BH As String) As ihi_rhf5.SERIALDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (SERIAL_BH Is Nothing) Then
                Throw New Global.System.ArgumentNullException("SERIAL_BH")
            Else
    ...
    Partial Public Class CheckMyMachineAndMaxSEQTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        r.MACHINE_ID, s.SEQ_NO AS MAX_SEQ_NO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            SERIAL AS s I"& _ 
                "NNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                             (SELECT        SERIAL_BH, MAX(SEQ_NO) AS"& _ 
                " MAX_SEQ"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               FROM            SERIAL"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"               "& _ 
                "                GROUP BY SERIAL_BH) AS ms ON s.SERIAL_BH = ms.SERIAL_BH AND s.SE"& _ 
                "Q_NO = ms.MAX_SEQ INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         RESULT AS r ON s.SERIAL_I"& _ 
                "D = r.SERIAL_ID INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         MACHINE AS m ON r.MACHINE_I"& _ 
                "D = m.ID INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         LINE_MASTER AS lm ON lm.ID = m.LIN"& _ 
                "E_ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (s.SERIAL_BH = @serialBH) AND (lm.SEQ * 1000 + m.SEQ >="&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                         (SELECT        TOP (1) lt.SEQ * 1000 + mt.SEQ AS Expr1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               FROM            LINE_MASTER AS lt INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                                                       MACHINE AS mt ON mt.LINE_"& _ 
                "ID = lt.ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               WHERE        (mt.ID = @currentMachine"& _ 
                "Id)))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY s.SERIAL_BH, lm.SEQ, m.SEQ"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@serialBH", Global.System.Data.SqlDbType.VarChar, 20, Global.System.Data.ParameterDirection.Input, 0, 0, "SERIAL_BH", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@currentMachineId", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByFromCurrentMachineHasResultInThisSeq(ByVal dataTable As ihi_rhf5.CheckMyMachineAndMaxSEQDataTable, ByVal serialBH As String, ByVal currentMachineId As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (serialBH Is Nothing) Then
                Throw New Global.System.ArgumentNullException("serialBH")
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(serialBH,String)
            End If
            Me.Adapter.SelectCommand.Parameters(1).Value = CType(currentMachineId,Integer)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
            Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataByFromCurrentMachineHasResultInThisSeq(ByVal serialBH As String, ByVal currentMachineId As Integer) As ihi_rhf5.CheckMyMachineAndMaxSEQDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (serialBH Is Nothing) Then
                Throw New Global.System.ArgumentNullException("serialBH")
            Else
