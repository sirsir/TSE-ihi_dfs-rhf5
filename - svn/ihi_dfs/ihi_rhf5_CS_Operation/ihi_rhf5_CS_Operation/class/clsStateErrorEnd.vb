    ...
    Private Sub Reply4ToPLC()
        ...
        While Not blnSent
            Try
                ...
                blnSent = True
                m_clsLogger.AppendLog(Me.GetType.Name, "Reply4ToPLC", "intReadStatus = " & PLC_WRITE_STATUS_ERROR & " at DM" & (My.Settings.WriteStatusAddressPCEnd), "Info")
